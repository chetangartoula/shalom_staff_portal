                ...
                <TableBody>
                    {section.rows.map((row, index) => (
                        <TableRow key={row.id}>
                            ...
                            <TableCell>
                                <Input type="number" value={row.no} onChange={e => onRowChange(row.id, 'no', Number(e.target.value), section.id)} className="w-20 bg-transparent border-0 focus-visible:ring-0 px-0" />
                            </TableCell>
                            <TableCell>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <Input id={`no-${row.id}`} type="number" value={row.no} onChange={e => onRowChange(row.id, 'no', Number(e.target.value), section.id)} />
                            </div>
                            <div className="space-y-1">
